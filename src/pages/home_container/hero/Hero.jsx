...
const Hero = () => {
  ...
  return (
    <div className="w-full h-[calc(100vh-8ch)] lg:ps-28 md:ps-16 sm:ps-7 ps-4 mt-[8ch] flex items-center justify-center flex-col hero relative">
      <div className="flex-1 w-full flex items-stretch justity-between gap-12 pb-10">
        <motion.dev
          className="w-[35%] h-auto rounded-md justify-center flex-col space-y-14"
        ...
        >
          ...
          >
            ...
            <motion.p
              className="text-lg font-nornal text-neutral-300 line-clamp-3 text-ellipsis "
              initial={{ opacity: 0, y: -10 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 2, ease: "linear", delay: 0.6 }}
            >
          ...
          <motion.button className="w-fit bg-violet-700 hover:bg-violet-800 text-neutral-50 font-medium py-3 px-6 rounded-md aese-in-out duration-300">
            Reserve Seat Now
          </motion.button>
        </motion.dev>
        ;{" "}
